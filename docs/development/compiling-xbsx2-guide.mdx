---
sidebar_position: 1
title: Guide to Install Visual Studio 2022 and Build XBSX2
description: Complete guide for setting up Visual Studio 2022 and compiling XBSX2 for Xbox deployment
---
...
3. Clone the `XBSX2` repository by running the following command:
    ```bash
    git clone https://github.com/XboxEmulationHub/XBSX2.git --recurse-submodules
    ```
