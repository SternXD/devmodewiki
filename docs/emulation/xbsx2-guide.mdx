...
On your computer, go to [GitHub](https://github.com/XboxEmulationHub/XBSX2/releases/latest) or [the Dev Store](https://xbdev.store/).
Download the latest version of XBSX2.
You'll get one file: the `.msix` or `.msixbundle` file (XBSX2 itself)
...
Upload the XBSX2 `.msix` or `.msixbundle` file.
